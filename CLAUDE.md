...
| `/back-of-house` | `app/back-of-house/page.tsx` | admin dashboard (`ADMIN_EMAILS` gate is server-side): KPIs, users, engagement + retention, AI usage & cost (ledger), credits & trial funnel, **Plan settings** (edits `app_config`), aisle-cache review, premium comps |
