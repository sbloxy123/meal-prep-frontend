...
function Dashboard({
  ...
  return (
    <div className="admin">
      ...
      {/* ④d Ingredient → aisle cache review */}
      <AisleSection />
...
// ── ④d Aisle cache review ────────────────────────────────────────────────────
// Model guesses nobody has checked, busiest first, and the lines the cache and
// the model both failed to place. One bad mapping lands on every household's
// list, so confirm or correct the queue regularly; human decisions stick.
